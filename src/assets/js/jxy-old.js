    ...
    if (outer.hasAttribute("jm-data")) {
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                var scripts1 = document.body.querySelectorAll("script:not(.accounted)");
                scripts1.forEach(function(element) {
                    console.log(element);
                ...
                /* 1 */
                var addScripts1 = document.body.querySelectorAll("script:not(.accounted)");
                addScripts1.forEach(function(element) {
                    var newScript1 = document.createElement("SCRIPT");
                    newScript1.innerHTML = element.innerHTML;
                    if (element.hasAttribute("src")) {
                        newScript1.setAttribute("src", element.getAttribute("src"));
                    }
                    newScript1.setAttribute("data-jxy-injected-script-from", lru);
        ...
        var scripts2 = document.body.querySelectorAll("script:not(.accounted)");
        scripts2.forEach(function(element) {
            element.classList.add('accounted');
        ...
        /* 1 */
        var addScripts2 = document.body.querySelectorAll("script:not(.accounted)");
        addScripts2.forEach(function(element) {
            var newScript2 = document.createElement("SCRIPT");
            newScript2.innerHTML = element.innerHTML;
            if (element.hasAttribute("src")) {
                newScript2.setAttribute("src", element.getAttribute("src"));
            }
            newScript2.setAttribute("data-jxy-injected-script-from", lru);
